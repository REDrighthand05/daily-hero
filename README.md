<div align="center">
  <h1>✦ Daily HeroUI ✦</h1>
  <p><strong>A desktop side-panel productivity experiment.<br>Built with HeroUI v2, Tauri v2 &mdash; now archived.</strong></p>
  ...
  <p>
    ...
    <img src="https://img.shields.io/badge/stack-HeroUI%20v2-8B5CF6?style=flat-square" alt="HeroUI">
...
```
frontend     React 19 · TypeScript · HeroUI v2 · Tailwind v3 · Zustand · i18next
...
|---|---|---|
| **daily-hero** | [HeroUI v2](https://heroui.com) + Tailwind v3 | ✅ Final release |
...
**[⬇ Download the final release](https://github.com/REDrighthand05/daily-hero/releases/tag/v1.2.1)**
